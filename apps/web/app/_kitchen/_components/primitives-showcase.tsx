...
import { StatusPill, type FreightStatus } from "@/components/primitives/StatusPill";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="rounded border border-[--color-amber-400]/50 bg-[--color-amber-400]/10 px-3 py-2 font-mono text-xs uppercase tracking-widest text-[--color-amber-400]"
        >
          Trigger Info Toast
        </button>
        <button
